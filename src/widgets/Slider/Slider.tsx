...
export const Slider = () => {
    ...
    return (
        ...
        <div className={`${styles.btn} ${styles.prev}`} onClick={prevSlide} role="button" tabIndex={0}>❮</div>
        <div className={`${styles.btn} ${styles.next}`} onClick={nextSlide} role="button" tabIndex={0}>❯</div>
